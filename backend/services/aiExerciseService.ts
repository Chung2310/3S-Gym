...
QUY TẮC BẮT BUỘC VỀ TÊN BÀI TẬP: Trường name (tên bài tập) PHẢI 100% LÀ TIẾNG ANH CHUẨN theo thuật ngữ thể hình và fitness quốc tế (ví dụ: "Barbell Bench Press", "Incline Dumbbell Press", "Romanian Deadlift", "Bulgarian Split Squat", "Lat Pulldown", "Plank", "Burpee", "Cable Tricep Pushdown", "Overhead Shoulder Press"...). TUYỆT ĐỐI KHÔNG dịch tên bài tập sang tiếng Việt kể cả khi yêu cầu của người dùng bằng tiếng Việt.
