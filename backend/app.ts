...
import workoutSessionDraftsRouter from './routes/workoutSessionDrafts.js';
...
app.use('/api/admin', adminCreditsRouter);
app.use('/api', workoutProgressRouter);
app.use('/api/workout-session-drafts', workoutSessionDraftsRouter);
