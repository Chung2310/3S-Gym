...
export const checkDuplicates = asyncHandler(async (req, res) => success(res, { message: 'Đã kiểm tra tên bài tập.', data: { names: await service.findDuplicateNames(req.body.names) } }));
