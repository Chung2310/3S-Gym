...
export interface IBodyMeasurement { customerId: mongoose.Types.ObjectId; ptId: mongoose.Types.ObjectId; measuredAt: Date; weight?: number; bodyFatPercentage?: number; muscleMass?: number; measurements: Record<string, number> }
