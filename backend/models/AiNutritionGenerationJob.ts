...
import type { NutritionGenerationInput } from '../services/aiNutritionGenerationJobService.js';

export type AiNutritionGenerationJobStatus = 'PENDING' | 'PROCESSING' | 'SUCCEEDED' | 'FAILED';
...
export default mongoose.model<IAiNutritionGenerationJob>('AiNutritionGenerationJob', schema);
