...
export const portalNavigation: NavigationItem[] = [
  { path: '/portal/pt/dashboard', label: 'Dashboard PT', section: 'Tổng quan', icon: LayoutDashboard, roles: ['PT'], feature: 'DASHBOARD' },
  { path: '/portal/notifications', label: 'Thông báo', section: 'Tổng quan', icon: Bell, roles: ['ADMIN', 'PT', 'CUSTOMER'] },
  { path: '/portal/calendar', label: 'Lịch nội bộ', section: 'Tổng quan', icon: CalendarDays, roles: ['ADMIN', 'PT'] },
  { path: '/portal/admin', label: 'Quản lý PT', section: 'Vận hành', icon: Users, roles: ['ADMIN'], matchChildren: true },
  { path: '/portal/pt/customers', label: 'Khách hàng', section: 'Vận hành', icon: Users, roles: ['PT'], matchChildren: true },
  ...
  { path: '/portal/pt/assistant', label: 'PT Assistant', section: 'Tri thức & trợ lý', icon: Bot, roles: ['PT'], feature: 'PT_ASSISTANT', matchChildren: true },
  { path: '/portal/pt/knowledge-search', label: 'Tra cứu tri thức', section: 'Tri thức & trợ lý', icon: Search, roles: ['PT'], feature: 'KNOWLEDGE_BASE', matchChildren: true },
  { path: '/portal/admin/knowledge', label: 'Kho tri thức', section: 'Tri thức & trợ lý', icon: BookOpen, roles: ['ADMIN'], feature: 'KNOWLEDGE_BASE', matchChildren: true },
  { path: '/portal/me', label: 'Hành trình của tôi', section: 'Tài khoản', icon: HeartPulse, roles: ['CUSTOMER'], matchChildren: true },
];
