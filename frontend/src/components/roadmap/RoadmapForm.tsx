...
export default function RoadmapForm({ onSaved, onCancel }: RoadmapFormProps) {
  ...
  return <form className="panel" onSubmit={submit}>
    <div className="form-grid">
      ...
      />
      <label className="field"><span>Tên roadmap</span><input aria-label="Tên roadmap" placeholder="Ví dụ: Lộ trình Giảm mỡ 12 tuần..." value={title} onChange={(event) => setTitle(event.target.value)} required /></label>
    </div>
